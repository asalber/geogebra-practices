...
\input{preamble/book-commands} % Insert the commands_book.tex file which contains the majority of the structure behind
% the template
...
%	CHAPTERS
%----------------------------------------------------------------------------------------
\include{chapters/geogebra-introduction}
\include{chapters/elementary-functions}
\include{chapters/limits-continuity}
\include{chapters/derivatives-one-variable}
...
\include{chapters/ordinary-differential-equations}
\include{chapters/derivatives-n-variables}
\end{document}
